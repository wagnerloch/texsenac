\documentclass[tcc,capa]{texsenac}
...
\unidade{CAMPUS PELOTAS}
\curso{Análise e Desenvolvimento de Sistemas}
\nomecurso{Tecnólogo em Análise e Desenvolvimento de Sistemas}
...
\author{Loch}{Wagner}
\advisor[Prof.~Me.]{Loch}{Wagner}
\coadvisor[Prof.~Me.]{Loch}{Wagner}
\collaborator[Prof.~Me.]{Loch}{Wagner}
...
\begin{aprovacao}{06 de dezembro de 2024} %data da banca por extenso
\noindent Prof. Me. Wagner Loch (orientador)\\
Mestre em Computação pela Universidade Federal de Pelotas.\\[1cm]

\noindent Prof. Dr. Edécio Fernando Iepsen\\
